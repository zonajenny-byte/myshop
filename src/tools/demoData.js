...
const DEMO = {
  ...
  "gift-etiquette": {
    occasion: "喬遷", relation_note: "同部門同事，交情普通但常一起吃飯",
    suggested_range: { low: 800, high: 1500, typical: 1200 },
    reasoning: "同事交情屬於「有往來但不算深交」，喬遷禮偏向祝賀性質不用重手。金額落在這個區間，收禮的人不會有壓力要回更大的禮。",
    gift_options: [
      { item: "現金禮（紅包或轉帳皆可）", why: "最不會出錯的選項，喬遷不像婚禮有固定行情，現金讓對方自己決定怎麼用" },
      { item: "生活用品（掃地機器人耗材、香氛、廚房小物）", why: "喬遷實用取向，避免送家具家電這類對方可能已經買好的大件" },
    ],
    etiquette_notes: [
      "喬遷不像婚喪有嚴格行情，金額彈性比你想的大，不用照著婚禮的邏輯算",
      "如果是租屋喬遷（不是買房），禮數可以更輕，一般會用小禮物取代包現金",
    ],
    wording: "恭喜喬遷之喜，新家溫馨美滿，順心如意。",
  },

  "style-planning": {
    style_summary: "你列的單品偏簡約基本款，白襯衫＋牛仔褲＋黑色小外套是很好搭的骨架，風格主軸適合走「乾淨俐落、稍微正式」的通勤路線，不用額外買太多配件就能撐出好幾套。",
    outfits: [
      { name: "俐落上班日", items: ["白襯衫", "黑色小外套", "牛仔褲"], occasion: "上班",
        why: "襯衫扎進去、外套敞開穿，比全套正裝輕鬆，又比純休閒正式，通勤場合最百搭的組合。" },
      { name: "週末咖啡廳", items: ["白襯衫（外面不扎）", "牛仔褲"], occasion: "朋友聚餐",
        why: "拿掉外套、襯衫放出來穿更隨性，同一件襯衫換個穿法就變成完全不同的場合感。" },
    ],
    wardrobe_gaps: [
      "如果想投資一件：一雙白色或米色的簡約包鞋，能同時撐起這兩套搭配，比黑鞋更提亮整體",
    ],
    styling_tips: [
      "襯衫的扎與不扎，是你現有這幾件單品切換正式感最快的方法，不用靠買新衣服",
      "黑色小外套是百搭關鍵單品，之後新買的衣服可以優先考慮跟它搭不搭",
    ],
  },

  "startup-basics": {
    business_model: {
      what: "手作療癒小物（如你描述的飾品／香氛類）＋搭配的線上內容或工具",
      who: "對身心療癒、手作有興趣，願意為「有故事的東西」多花一點錢的族群，通常先從你現有的社群關注者開始",
      how_money: "商品銷售為主，之後可以疊加訂閱制或數位內容作第二收入來源",
    },
    pricing: {
      approach: "先用「材料成本 × 3 到 4 倍」抓一個起始價，不要只算材料錢，你的時間、包裝、品牌溢價都要算進去",
      reasoning: "手作類商品最常見的錯誤是照成本訂價，忘記算自己的工時。剛開始可以訂價偏低一點測試市場反應，之後有口碑再往上調，比一開始定太高後來要往下砍容易。",
      range: "以你描述的品項，起始價落在 NT$500–1500 區間比較合理，可以先做 3–5 件測試市場反應",
    },
    first_customer_steps: [
      { step: "先找 5 個朋友", detail: "不是要他們捧場買，是要他們老實說「會不會買」「多少錢會買」——這比問陌生人準確" },
      { step: "用一張照片測水溫", detail: "在你已經有的社群發一則貼文，講清楚在做什麼、多少錢，看有沒有人主動問，不用先做好整套網站" },
      { step: "第一筆訂單手動處理就好", detail: "不用一開始就架金流、做官網，前 5–10 筆訂單用轉帳、私訊處理完全沒問題，先驗證有人要買再投資基礎建設" },
    ],
    risks: [
      "最常見的坑：還沒賣出第一件就先花錢做網站、拍形象照——順序反了，先驗證有人要買",
      "訂價定得太低，之後很難往上調，寧可一開始稍微保守估高一點",
    ],
    next_checkpoint: "賣出前 5 件之後，回頭看：誰買的、為什麼買、嫌貴還是覺得划算——這些答案會告訴你要不要繼續、要不要調價。",
  },

  "viral-video-script": {
    topic: "分享一個生活小知識", platform: "Reels / Shorts",
    hook_options: [
      { line: "「你可能一直做錯了」", why: "點出認知落差，觀眾會想確認自己是不是那個「做錯的人」，這是最容易留住人的鉤子類型。" },
      { line: "直接show結果，再倒帶解釋", why: "先讓觀眾看到「哇」的那一刻，好奇怎麼做到的，比從頭講起更抓得住人。" },
      { line: "用一個問題開場，故意不馬上回答", why: "製造懸念，觀眾會想看完才知道答案，但問題要真的跟主題有關，不能為了懸念硬掰。" },
    ],
    script_outline: [
      { time: "0–3秒", beat: "鉤子", purpose: "決定觀眾滑不滑走的關鍵三秒，資訊量要低但情緒要夠" },
      { time: "3–10秒", beat: "帶入主題", purpose: "快速講清楚「這支影片要講什麼」，不要拖泥帶水" },
      { time: "10–25秒", beat: "主要內容", purpose: "核心資訊放這裡，一支影片講一件事，不要塞太多點" },
      { time: "25–30秒", beat: "收尾／行動呼籲", purpose: "留一個記憶點或引導留言互動，比單純說「謝謝觀看」更有效" },
    ],
    title_ideas: [
      { text: "沒人告訴你的＿＿", why: "暗示資訊落差，觸發「我是不是漏掉什麼」的好奇心" },
      { text: "我試了＿＿，結果意外的是", why: "「意外」兩個字暗示反差，反差感是短影音很吃的元素" },
    ],
    notes: [
      "會不會紅還跟帳號歷史表現、發布時機、平台當下的演算法有關，這幾點是任何工具都保證不了的",
      "同一個鉤子用久了觀眾會免疫，這裡的三種寫法建議輪流用，不要每支都套同一招",
    ],
  },

  "invest-planner": {
    inputs: { monthly: 10000, years: 10, rate: 6, goal: "頭期款" },
    principal: 1200000,
    scenarios: [
      { label: "悲觀", rate: 2, value: 1329409, gain: 129409 },
      { label: "你填的假設", rate: 6, value: 1646987, gain: 446987, primary: true },
      { label: "樂觀", rate: 9, value: 1949656, gain: 749656 },
    ],
    inflation: {
      rate: 2,
      realValue: 1351103,
      note: "同樣一筆錢，十年後買得到的東西比現在少。上面 164 萬的帳面數字，換算成現在的購買力大約是 135 萬——這才是你實際感受得到的。",
    },
    milestones: [
      { year: 3, principal: 360000, value: 393384 },
      { year: 5, principal: 600000, value: 697700 },
      { year: 10, principal: 1200000, value: 1646987 },
    ],
    observations: [
      "十年裡有 27% 來自報酬、73% 來自你自己存的錢——前期主要靠紀律，複利要到後段才明顯。",
      "如果每月多投 2000（變成 12000），十年後大約多 33 萬。金額的影響比報酬率的假設更直接。",
      "悲觀跟樂觀之間差了 62 萬。這個落差就是市場風險的實際大小，不是理論上的說法。",
    ],
    notes: [
